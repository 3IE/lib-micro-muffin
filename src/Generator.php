...
\n");
  ...
  private function writeOneToManyJoin($foreignTableName, $foreignColumnName, $tableName, $fieldName, $columnType)
  {
    ...
    $str .= TAB . " */\n";
    $str .= TAB . 'public function get' . $varUppered . "(\$order = null)\n";
    $str .= TAB . "{\n";
    $str .= TAB . TAB . "if (is_null(\$this->" . $var . "))\n";
    $str .= TAB . TAB . "{\n";
    $str .= TAB . TAB . TAB . "\$pdo = \\Lib\\PDOS::getInstance();\n";
    $str .= TAB . TAB . TAB . "if (!is_null(\$order))\n";
    $str .= TAB . TAB . TAB . TAB . "\$query = \$pdo->prepare('SELECT * FROM " . $procedure . "('.\$this->_" . $fieldName . ".') ORDER BY '.\$order);\n";
    $str .= TAB . TAB . TAB . "else\n";
    $str .= TAB . TAB . TAB . TAB . "\$query = \$pdo->prepare('SELECT * FROM " . $procedure . "('.\$this->_" . $fieldName . ".')');\n";
